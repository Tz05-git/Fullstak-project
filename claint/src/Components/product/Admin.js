...
const Admin = () => {
            ...
            <div className="col-12 sm:col-6 lg:col-12 xl:col-4 p-2" key={product._id}>
                <div className="p-4 border-1 surface-border surface-card border-round">
                    ...
                    <div className="flex align-items-center justify-content-between">
                        <span className="text-2xl font-semibold">${product.price}</span>
                        <Button icon="pi pi-shopping-cart" className="p-button-rounded" disabled={product.inventoryStatus === 'OUTOFSTOCK'} />
                        <Button label='עדכן' severity='help' onClick={() =>{setVisibleUpdate(true);setId(product._id)}} />
                        <div className="card flex justify-content-center">
                            <Button onClick={() => handleDelete(product._id)} label="Delete" icon="pi pi-trash" />
    ...
    return (<>
        ...
        {visibleUpdate&&<EditProduct visible={visibleUpdate} setVisible={setVisibleUpdate} id={id}/>}
        </>
    );
